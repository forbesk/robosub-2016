  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.I32) {
        this.source = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.DOUBLE) {
        this.computeTime = input.readDouble().value;
      } else {
        input.skip(ftype);
      }
      break;
...
Filter.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.I32) {
        this.sinkType = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
Resolution.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.I32) {
        this.horizontal = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 2:
      if (ftype == Thrift.Type.I32) {
        this.vertical = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
